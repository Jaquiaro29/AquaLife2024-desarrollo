...
import { collection, onSnapshot, query, where, getDocs, DocumentData, orderBy, limit } from 'firebase/firestore';
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.cardsContainer}>
          ...
          >
            ...
            <Text style={styles.cardValue}>$2,540</Text>
        ...
        <View style={[styles.chartSection, styles.sectionElevated]}>
          ...
          <View style={styles.chartStats}>
            <View style={styles.chartStat}>
              ...
              <Text style={styles.chartStatValue}>$111,000</Text>
            </View>
            <View style={styles.chartStat}>
